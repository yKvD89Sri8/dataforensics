...
member_data_file_path = "member_data_with_attr_part_02.joblib"
nonmember_data_file_path = "nonmember_data_200records.joblib"
...
for i_sampling in range(num_sampling):
    ...
    for one_loss in member_ds_clip:
