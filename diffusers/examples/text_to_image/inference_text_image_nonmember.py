...
####### load member data#####
num_data = 200
member_data_file = "diffusers/data/laion2b_chinese_release/train-00001-of-00013.parquet"
...
for i, data in enumerate(validation_list):
    ...
    print("finish one")
    if (i+1) % 20 == 0:
        joblib.dump(loss_list, "./nonmember_data_200records.joblib")
        print("in {} step, save in {}".format(i+1, "./nonmember_data_200records.joblib" ))
joblib.dump(loss_list, "./nonmember_data_200records.joblib")
# save image
