...
#file_path = "../tmp/analyze_member_data.joblib"
...
for idx in range(num_repeat):
    ...
    xstart_mse_auc, xstart_mse_acc, xstart_mse_f1 = metrics_eval_list_mode(member_img_step_xstart_mse_list[:num_samples], nonmember_img_step_xstart_mse_list[:num_samples], truncate_start=args.truncate_start, truncate_end=args.truncate_end)
